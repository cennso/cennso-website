...
export const FormSwitch: FunctionComponent<FormSwitchProps> = ({
  ...
  return (
    <button
      ...
      className={`${className} ${checked ? 'bg-[#FF5D18]' : 'bg-white'} flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600`}
      role="switch"
