...
export const HexagonDoubleGradient: FunctionComponent<HexagonDoubleProps> = ({
  ...
  return (
    <div className="relative">
      <div
        className={`w-full h-full absolute top-0 left-[5%] ${
          gradient ? 'bg-linear-to-t/srgb from-[#1b7dbe] to-[#1b7dbe]' : ''
      ...
      <div
        className={`relative ${className} shadow-lg shadow-white ${
          gradient ? 'bg-linear-to-t/srgb from-primary-600 to-[#1b7dbe]' : ''
